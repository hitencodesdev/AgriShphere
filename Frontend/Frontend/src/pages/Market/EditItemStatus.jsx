                   ...
                   <div className=' flex flex-col gap-4 items-center justify-center '>
                    ...
                    <div className="grid gap-4 mt-6 items-center justify-center">
                        {orders.length === 0  ? (
                            ...
                            orders.map((order) => (
                                (order.status === "Confirm" ||  order.status === "Shipped")  && <div key={order._id} className="bg-white shadow-md p-4  rounded-lg justify-center  grid md:grid-cols-2 w-fit ">
                                    ...
                                    <div className="flex  justify-center mb-20 gap-2 md:items-end items-center">
                                       { order.status != "Shipped" && <button
                                            onClick={() => editStatus(order._id, 'Shipped')}
                                            className="px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition"
                                        >
                                            Shipped
                                        </button>}
                                        <button
                                            onClick={() => editStatus(order._id, 'Delivered')}
